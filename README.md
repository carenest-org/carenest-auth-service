# CareNest Auth Service

Authentication and authorization microservice for the CareNest healthcare platform.
...
```
jayadevarun2003/carenest-auth-service:latest
jayadevarun2003/carenest-auth-service:sha-abc1234
jayadevarun2003/carenest-auth-service:v1.2.0     ← only when git tag exists
```
...
```bash
# Build locally
docker build -t carenest-auth-service .

# Run locally
docker run -p 3001:3001 --env-file .env carenest-auth-service
```
